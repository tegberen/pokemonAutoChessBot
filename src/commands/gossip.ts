...
export async function execute(interaction) {
	...
	const variations = [
		...
		`${randomName} should try ${randomSynergy1}-${randomSynergy2} boards.`,
		`When in doubt, listen to ${randomName}, and play ${randomSynergy1} or ${randomSynergy2}`,
		`${randomName} stop one tricking ${randomSynergy1} and play ${randomSynergy2} instead.`,
		`${randomName} your last ${randomSynergy1} game was not da wae. This would not happen with ${randomSynergy2} and you know that.`,
		`We believe in ${randomSynergy1} in this household, right ${randomName}?`,
		...
		`${randomName}. Why are you always so right.`,
