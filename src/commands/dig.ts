	...
	try {
		...
		if (isPokemon) {
			...
			if (isTreasure) {
				...
				return interaction.editReply({
				content: `You found a rare treasure!!! You unearthed ${treasure.name}, it is valued at $${randomPrice}! <:pog:1416513137536008272>`,
