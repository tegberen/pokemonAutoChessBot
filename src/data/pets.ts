export const catBreeds = [
  ...
  "Khao_Manee",
  "Korat",
  "Korat#Thai_Lilac,_Thai_Blue_Point_and_Thai_Lilac_Point",
  "Kuril_Islands",
  "Kurilian_Bobtail",
  "LaPerm",
  "Ladoga_Karelia",
  ...
  "Ragdoll",
  "Russian_Blue",
  "Russian_White,_Black,_and_Tabby",
  "Savannah_cat",
  "Scottish_Fold",
  "Selkirk_Rex",
  "Serengeti_cat",
...
export const dogBreeds = [
  ...
  "Billy_(dog)",
  "Black_Mouth_Cur",
  "Black_Mouth_Cur#Florida_counterpart",
...
export const donkeyBreeds = [
  ...
  "Asinara",
  "Asinara_donkey",
  "Asno_de_las_Encartaciones",
  "Balkan_donkey",
  "Baudet_du_Poitou",
  "Bulgaria",
  "Burro_da_Ilha_Graciosa",
  "Burro_de_Miranda",
  "Campania",
  "Catalan_donkey",
  "Cyprus_donkey",
...
export const horseBreeds = [
  ...
  "Esperia_Pony",
  "Ethiopian_horses",
  "Ethiopian_horses#Bale",
  "Ethiopian_horses#Borana",
  "Ethiopian_horses#Horro",
  "Ethiopian_horses#Kafa",
  "Ethiopian_horses#Ogaden",
  "Ethiopian_horses#Selale",
  "Exmoor_pony",
  "Falabella",
  "Faroe_pony",
  "Feral_horse",
  ...
  "Mountain_and_moorland_pony_breeds",
  "Murgese",
  "Mustang",
  "Mérens_horse",
  "Namib_Desert_Horse",
...
export const rabbitBreeds = [
  ...
  "Algeria",
  "American_Fuzzy_Lop",
  "American_Rabbit_Breeders_Association",
  "American_rabbit",
  "Angora_rabbit",
  "Angora_rabbit#English_Angora",
  "Angora_rabbit#German_Angora",
  "Angora_rabbit#Giant_Angora",
  "Angora_rabbit#Satin_Angora",
  "Armenia",
  "Austria",
  "Beige_rabbit",
  "Belgian_Hare",
...
export const waterBuffaloBreeds = [
  "Bhadawari",
  "Buffalypso",
  "Bulgarian_language",
  "Burmese_language",
